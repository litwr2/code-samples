...
const int sizeDelta = 4; //used to adopt height of client area
...
bool X11FrameWnd::createWindow(int x, int y, int w, int h)
{
	...
	w += (wndRect.right - wndRect.left) - (clientRect.right - clientRect.left) - sizeDelta;
	h += (wndRect.bottom - wndRect.top) - (clientRect.bottom - clientRect.top) - sizeDelta;
