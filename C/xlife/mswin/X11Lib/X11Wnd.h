...
public:
	...
	public:
		...
		friend unsigned long get_m_foreColour(Context* c) {return c->m_foreColour;};
		friend unsigned long get_m_backColour(Context* c) {return c->m_backColour;};
		friend int get_m_drawMode(Context* c) {return c->m_drawMode;};
	...
	void drawRects(Context* context, RECT* rects, int numRects);
